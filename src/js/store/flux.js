	...
	return {
		...
		actions: {
			...
			login: async (email, password, name) => {
				try{
				let response = await fetch("https://supreme-disco-6946gj9wp55f4pw6-3000.app.github.dev/login", {
					method: 'POST',
					headers:{
			...
			getFavorites: async () => {
				...
				try{
					let response = await fetch("https://supreme-disco-6946gj9wp55f4pw6-3000.app.github.dev/users/favorites", {
						method: 'GET',
						headers:{
							'Content-Type':'application/json',
			...
			addFavoritesCharacters: async (name, uid) => {
				let token = localStorage.getItem("token")
				try{
				let response = await fetch(`https://supreme-disco-6946gj9wp55f4pw6-3000.app.github.dev/favorite/people/${uid}`, {
					method: 'POST',
					headers:{
						'Content-Type':'application/json',
						'Authorization': "Bearer "+token
			...
			deleteFavoritesCharacters: async (id) => {
				let token = localStorage.getItem("token")
				try{
				let response = await fetch(`https://supreme-disco-6946gj9wp55f4pw6-3000.app.github.dev/favorite/people/${id}`, {
					method: 'DELETE',
					headers:{
						'Content-Type':'application/json',
						'Authorization': "Bearer "+token
			...
			addFavoritesPlanets: async (name, uid) => {
				let token = localStorage.getItem("token")
				try{
				let response = await fetch(`https://supreme-disco-6946gj9wp55f4pw6-3000.app.github.dev/favorite/planet/${uid}`, {
					method: 'POST',
					headers:{
						'Content-Type':'application/json',
						'Authorization': "Bearer "+token
			...
			deleteFavoritesPlanets: async (id) => {
				let token = localStorage.getItem("token")
				try{
				let response = await fetch(`https://supreme-disco-6946gj9wp55f4pw6-3000.app.github.dev/favorite/planet/${id}`, {
					method: 'DELETE',
					headers:{
						'Content-Type':'application/json',
						'Authorization': "Bearer "+token
			...
			removeFav: async (type, id) => {
				...
				try {
					const response = await fetch(`https://supreme-disco-6946gj9wp55f4pw6-3000.app.github.dev/favorite/${type}/${id}`, {
						method: 'DELETE',
						headers:{
							'Content-Type':'application/json',
							'Authorization': "Bearer " + token
